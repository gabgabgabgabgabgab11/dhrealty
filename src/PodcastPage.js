...
const podcasts = [
  {
    title: "The Real Estate Roundtable",
    desc: "A deep dive into market shifts, investment trends, and expert interviews. New episode every week.",
    image: "https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=800&q=80",
    tag: "Podcast",
  },
  {
    title: "Homebuyer’s Guide",
    desc: "Actionable tips and expert guests for first-time and repeat homebuyers.",
    image: "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?auto=format&fit=crop&w=800&q=80",
    tag: "Guide",
  },
  {
    title: "Sustainable Living",
    desc: "Conversations with leaders in green real estate and eco-friendly lifestyles.",
    image: "https://images.unsplash.com/photo-1449247613801-ab06418e2861?auto=format&fit=crop&w=800&q=80",
    tag: "Sustainability",
  },
  {
    title: "Investment Insights",
    desc: "Seasoned investors share their strategies and stories for building wealth through property.",
  ...
  return (
    <div style={{ background: "#f6f8fa", minHeight: "100vh", margin: 0 }}>
      ...
      >
        ...
        >
          Listen to our latest episodes and discover insights from real estate leaders and innovators.
        </p>
      </section>
      <section style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          <div style={{
            flex: 1.3,
            background: `url(${podcasts[0].image}) center center/cover no-repeat`,
            minWidth: 260,
            maxWidth: 450,
          }} />
          <div style={{
