...
const pressItems = [
  {
    title: "National Real Estate Weekly Feature",
    desc: "Our agency was highlighted in National Real Estate Weekly for innovative marketing strategies and record-breaking local sales.",
    image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=900&q=80",
    tag: "Feature",
  },
  {
    title: "Local News Interview",
    desc: "Our principal broker discussed the latest housing market trends on Local News Channel 7.",
    image: "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?auto=format&fit=crop&w=900&q=80",
    tag: "Interview",
  },
  {
    title: "Top Brokerage Award Coverage",
    desc: "Covered by Real Estate Times for winning the Top Brokerage Award for three consecutive years.",
    image: "https://images.unsplash.com/photo-1523217582562-09d0def993a6?auto=format&fit=crop&w=900&q=80",
    tag: "Award",
  },
  {
    title: "Magazine Profile",
    desc: "Profiled in City Living Magazine for outstanding community service and client satisfaction.",
  ...
  return (
    <div style={{ background: "#f6f8fa", minHeight: "100vh", margin: 0 }}>
      ...
      >
        ...
        >
          Explore our latest press features, interviews, and media coverage.
        </p>
      </section>
      ...
      >
        ...
        >
          <div style={{
            flex: 1.3,
            background: `url(${pressItems[0].image}) center center/cover no-repeat`,
            minWidth: 260,
            maxWidth: 450,
          }} />
          <div style={{
      ...
      {/* Subgrid of remaining press items */}
      <section
        style={{
          maxWidth: 1200,
      ...
      >
        {pressItems.slice(1).map((item, idx) => (
          <div
            key={item.title}
            style={{
              background: "#fff",
